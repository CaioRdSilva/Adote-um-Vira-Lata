...
const BannerCabecalho = () => (
  <div className="relative w-full mx-auto sm:md:w-full lg:xl:2xl:w-5/6 aspect-wall">
    <Image
...
const DescCabecalho = () => (
  <div className="pt-0 pb-2">
    <p className="text-gray-400 text-md sm:text-md md:lg:xl:2xl:text-lg">
      ...
      santis. Nec orci ornare consequat. Praesent lacinia ultrices consectetur.
...
const InteracoesCabecalho = () => (
  <div className="flex my-auto">
    ...
    <div className="flex mr-4">
      ...
      <h1 id="CommentQuantidade">123</h1>
    </div>
