...
const InteracoesEvento = () => (
    <div className='inline-flex space-x-[6px]'>
        ...
        <div id ='Heart' className='inline-flex text-center'>
        ...
        <div id='Share' className='inline-flex text-center'> 
...
const TitulotipoEvento = () => (
    <div className='inline-flex'>
        <div className='inline-flex w-full align-middle'>
            <h1 id='titulo' className='pr-10 text-xl font-bold'>All dogs go to heaven</h1>
