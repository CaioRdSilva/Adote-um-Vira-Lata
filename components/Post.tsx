...
const Post: React.FC<PostListProps> = ({ posts }) => (
  <>
    <div className="grid grid-cols-2 gap-4 md:grid-cols-2 min-lg:max-2xl:grid-cols-2">
      {posts.map((post) => (
        <div className="flex md:lg:xl:2xl:flex bg-[#fafafa] min-h-[min(20em, 320px)] min-w-[min(100%, 752px)] m-2 rounded-xl drop-shadow-md">
          ...
          <div className="md:lg:xl:2xl:w-[60%] md:xl:h-full">
            <div className="mx-5 my-2">
              <div className="w-full">
                <>
                  <h1
                    className="text-xl font-bold md:max-2xl:text-2xl"
                    key={post.id}
                  >
                    {post.text}
                  </h1>
...
const TipoleituraPost = () => (
  <div className="inline-flex md:max-2xl:text-xl">
    <div>
      <h2 className="text-orange-400 text-ms text-bold">Adoção</h2>
    </div>
    <div className="mx-2">
      <h1>•</h1>
    </div>
    <div>
      <h2 className="text-ms">4 min</h2>
    </div>
  </div>
);
const AutorPost = () => (
  <div className="flex text-xl">
    <div className="mr-2 relative w-[35px] h-[35px] bg-black rounded-full">
      <Image className="full-rounded" fill src="/images/LOGO.webp" alt={""} />
    </div>
...
const DescPost = () => (
  <div className="mx-2">
    <p className="">
      Universidade Federal de Pernambuco - UFPE Pró-reitora de extensão e
      cultura Centro de Biociências Departamento de Histologia e...
    </p>
  </div>
);
